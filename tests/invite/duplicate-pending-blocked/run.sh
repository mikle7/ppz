...
curl_server "/accounts/alpha/invites" -X POST -d "username=alice" -o /dev/null -w "first:%{http_code}\n"
curl_server "/accounts/alpha/invites" -X POST -d "username=alice" -o /dev/null -w "second:%{http_code}\n"
